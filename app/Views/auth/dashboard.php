                ...
                <?php foreach (array_slice($recentUsers ?? [], 0, 5) as $user): ?>
                  <div class="list-group-item px-0">
                    <div class="d-flex justify-content-between align-items-center">
                      ...
                      <span class="badge badge-primary badge-pill"><?= date('M d', strtotime($user['created_at'])) ?></span>
                    </div>
                  </div>
                <?php endforeach; ?>
              </div>
                ...
                <?php foreach (array_slice($recentCourses ?? [], 0, 5) as $course): ?>
                  <div class="list-group-item px-0">
                    <div class="d-flex justify-content-between align-items-center">
                      ...
                      <span class="badge badge-success badge-pill"><?= esc($course['units']) ?> units</span>
                    </div>
                  </div>
                <?php endforeach; ?>
              </div>
      ...
      <div class="col-lg-3 col-md-6 mb-3">
        <div class="card stat-card border-left-success">
          <div class="card-body">
            <div class="d-flex align-items-center">
              <div class="flex-grow-1">
                <h4 class="card-title mb-0 text-success"><?= count($teacherCourses ?? []) ?></h4>
          ...
          <div class="card-body">
            <?php if (!empty($teacherCourses ?? [])): ?>
              ...
              <div class="mt-3 text-center">
                <a href="<?= base_url('courses') ?>" class="btn btn-outline-success btn-sm">View All Courses</a>
              </div>
            <?php else: ?>
              <div class="text-center py-4">
                <i class="fas fa-book fa-2x text-success mb-3"></i>
                ...
                <a href="<?= base_url('courses/create') ?>" class="btn btn-success">Create Your First Course</a>
              </div>
            <?php endif; ?>
          </div>
        </div>
                  ...
                  <div class="list-group-item px-0">
                    <div class="d-flex justify-content-between align-items-center">
                      <div>
                        ...
                        <small class="text-muted">Course: <?= esc($material['course_code'] ?? '') ?></small>
                      </div>
                      <span class="badge badge-success badge-pill"><?= date('M d', strtotime($material['created_at'] ?? 'now')) ?></span>
                    </div>
                  </div>
                <?php endforeach; ?>
              </div>
    ...
    <div class="card">
      ...
      <div class="card-body">
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 mb-3">
            <a href="<?= base_url('assignments') ?>" class="btn btn-outline-success btn-block">
              <i class="fas fa-clipboard-list fa-lg mb-2"></i><br>
              <span>Manage Assignments</span>
            </a>
          </div>
          <div class="col-lg-4 col-md-6 mb-3">
            <a href="<?= base_url('announcements') ?>" class="btn btn-outline-success btn-block">
