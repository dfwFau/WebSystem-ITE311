...
<div class="page-header">
    <h1><i class="fas fa-edit me-3"></i><?= esc($title) ?></h1>
    ...
    <form action="<?= base_url('programs/update/' . $program['id']) ?>" method="post">
        ...
        <div class="mb-4">
            ...
            <textarea class="form-control" id="description" name="description" 
                      rows="4" placeholder="Describe the program, its goals, and what students will learn..."><?= old('description', $program['description']) ?></textarea>
